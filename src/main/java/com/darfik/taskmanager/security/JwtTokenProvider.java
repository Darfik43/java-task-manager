...
public class JwtTokenProvider {
    ...
    public JwtResponse refreshUserTokens(String refreshToken) {
        ...
        TaskUser taskUser = userService.getById(userId);
        //TODO jwtResponse.setAccessToken(createAccessToken(userId, user.getEmail(), user.getRoles())); ??? Pochemu eta stroka zakommenchena??
        jwtResponse.setRefreshToken(createRefreshToken(userId, taskUser.getEmail()));
        return jwtResponse;
    }
